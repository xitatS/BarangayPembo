...
$sql = "SELECT * FROM req_tentnchairs";
...
if (isset($_GET['ID']) && isset($_GET['action'])) {
    ...
    if ($action === 'approve') {
        ...
        $updateSql = "UPDATE req_tentnchairs SET STATUS = 'Approved' WHERE ID = $lrn";
        $conn->query($updateSql);
    } elseif ($action === 'delete') {
        // Example: Update the status to 'Declined'
        $updateSql = "UPDATE req_tentnchairs SET STATUS = 'Declined' WHERE ID = $lrn";
        $conn->query($updateSql);
    }
...
/*            margin-left: 15%;*/
        ...
        .bcourt_permit:hover, .indigency:hover {
           background-color: #4fa2ed; 
            color: #fff;
            text-decoration: none;
        }
...
<body>
    <div class="container2">
      <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header" style="width:100%">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo SITEURL; ?>" onclick="return"><i class="fas fa-sign-out-alt mr-2"></i>Edit Profile</a>              
            </li>
      ...
      <table id="example" class="table table-striped table-bordered" style="width:100%">
        <h2>Request Tent and Chairs</h2>

        <button class="bcourt_permit"> <a href="admin_dashboard.php"><span>BASKETBALL COURT PERMIT</span></a></button>
        <button class="indigency" ><a href="indigency.php"><span>INDIGENCY APPLICATIONS</span> 
        ...
        <tr>
                ...
                <th>Tents Requested</th>
                <th>Chairs Requested</th>
                 <th>Purpose</th>
                  <th>Permit Code</th>
                   <th>Status</th>
                    <th>Actions</th>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row['REQUESTED_UNTIL'] . "</td>";
                echo "<td>" . $row['TENTS_REQUESTED'] . "</td>";
                echo "<td>" . $row['CHAIRS_REQUESTED'] . "</td>";
                echo "<td>" . $row['PURPOSE'] . "</td>";
                echo "<td>" . $row['PERMIT_CODE'] . "</td>";
