...
<body>
    <div class="card ">
        <div class="card-header">
            <h3 class='text-center1'>User Profile <span class="float-right"> <a href="index.php" class="btn btn-primary">Back</a> </h3>
        </div>
        <div class="card-body">
            ...
            <?php if (Session::get("roleid") == '4' || (Session::get("roleid") == '1' && Session::get("id") != $getUinfo->id)) { ?>
            ...
            ?>">
                    ...
                    <?php } elseif (Session::get("roleid") == '1' || Session::get("roleid") == '4') { ?>
