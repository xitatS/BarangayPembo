...
$sql = "SELECT * FROM indigency_applications";
...
if (isset($_GET['ID']) && isset($_GET['action'])) {
    ...
    if ($action === 'approve') {
        ...
        $updateSql = "UPDATE indigency_applications SET STATUS = 'Approved' WHERE ID = $lrn";
        $conn->query($updateSql);
    } elseif ($action === 'delete') {
        // Example: Update the status to 'Declined'
        $updateSql = "UPDATE indigency_applications SET STATUS = 'Declined' WHERE ID = $lrn";
        $conn->query($updateSql);
    }
...
<body>
    <div class="container2">
      <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header" style="width:100%">
        ...
        <button class="indigency" ><a href="admin_dashboard.php"><span>
            BASKETBALL COURT PERMIT</span>
